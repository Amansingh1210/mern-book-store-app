        ...
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 py-6 mb-4 mt-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    ...
                    <input 
                     {...register("email", { required: true })}type="email" name='email' id='email' placeholder='Email Address' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow' />
                </div>
            ...
            {/* google signin */}
            <div className='mt-4'>
                <button onClick={handleGooglSignIn} className='w-full flex flex-wrap items-center justify-center gap-1 bg-secondary hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none'>
